...
export const KnowledgeCard = React.memo<KnowledgeCardProps>(
  ({ item, onViewDocument, onViewCodeExamples, onExport, onDeleteSuccess, activeOperation, onRefreshStarted }) => {
