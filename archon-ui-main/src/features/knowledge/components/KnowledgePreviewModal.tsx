...
export const KnowledgePreviewModal: React.FC<KnowledgePreviewModalProps> = ({ isOpen, onClose, title, url }) => {
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      ...
      >
        ...
        <div className="flex-1 bg-gray-100 dark:bg-black/20 p-0 relative">
          {isPdf ? (
            <iframe src={`${url}#toolbar=0`} className="w-full h-full bg-white" title={title} />
          ) : isOffice ? (
            <iframe
