...
## 1. 實戰背景
一家擁有 50 家實體門市的零售品牌，面臨庫存分配不均與行銷效率低下的挑戰。透過 Archon 的 RAG 協作模式，我們協助其提升了 30% 營收。
...
此案例證明，正確的「人機協作」能將數據直接轉化為商業價值。', 'Alice (Sales VP)', '2025-01-12T14:00:00Z', 'https://picsum.photos/seed/case-retail/600/400')
ON CONFLICT (id) DO NOTHING;
