...
var unlocked_action_cards: Array = ["action_keyword"]
var equipped_action_cards: Array = ["action_keyword"]
...
func _parse_loaded_data(data) -> void:
    if typeof(data) == TYPE_DICTIONARY:
        ...
        unlocked_action_cards = data.get("unlocked_action_cards", ["action_keyword"])
        equipped_action_cards = data.get("equipped_action_cards", ["action_keyword"])
...
func _reset_to_default() -> void:
    career_level = 3
    max_player_hp = 100.0
    unlocked_action_cards = ["action_keyword"]
    equipped_action_cards = ["action_keyword"]
