...
export const handlers = [
  ...
  http.get('*/api/blogs/:id', () => HttpResponse.json({ id: 'post-1', title: 'Mock Post', content: 'content' })),
  ...
  http.get('*/api/admin/rbac/matrix', () => HttpResponse.json([])),
  http.get('*/api/auth/permissions', () => HttpResponse.json([])),
