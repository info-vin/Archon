    ...
    <>
      ...
      {previewUrl && (
        <div className="w-full h-64 md:h-80 relative group overflow-hidden bg-slate-900 shrink-0">
          ...
          <button
            ...
            className="absolute top-6 right-6 p-3 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl text-white hover:bg-white/20 transition-all opacity-0 group-hover:opacity-100 shadow-xl focus-visible:ring-2 focus-visible:ring-indigo-500"
      ...
      <div className="flex-1 p-8 md:p-16 max-w-4xl mx-auto w-full relative">
        ...
        <div className="flex flex-wrap items-center gap-4 mb-8">
            ...
            className="flex items-center px-4 py-2 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-indigo-50 hover:text-indigo-600 transition-all disabled:opacity-50 shrink-0 focus-visible:ring-2 focus-visible:ring-indigo-500"
          >
