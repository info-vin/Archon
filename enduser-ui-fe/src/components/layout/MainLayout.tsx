            ...
            <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:z-50 focus:p-4 focus:bg-background focus:text-foreground focus:ring-2 focus:ring-primary focus:outline-none">
             ...
             >
                ...
                <div className={`p-4 border-t border-border flex flex-col ${isCollapsed ? 'items-center' : ''}`}>
                   ...
                   <button type="button" onClick={logout} title={isCollapsed ? "Logout" : undefined} className={`w-full flex ${isCollapsed ? 'flex-col items-center justify-center p-2 text-[10px]' : 'items-center justify-center p-2'} rounded-md bg-destructive text-destructive-foreground hover:bg-destructive/90 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2`}>
