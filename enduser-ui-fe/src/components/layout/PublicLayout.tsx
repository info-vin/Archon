        ...
        >
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <BrandLogo className="w-8 h-8" />
              <button type="button" onClick={() => setIsMobileMenuOpen(false)} className="p-1 -mr-1 rounded-md hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" aria-label="Close menu">
