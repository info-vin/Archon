...
const MOCK_TASKS: Task[] = [
    ...
    { id: 'task-4', project_id: 'proj-1', title: 'Fix authentication bug', description: 'Users are reporting intermittent login failures.', status: TaskStatus.REVIEW, assignee: 'Alice Johnson', task_order: 3, priority: TaskPriority.HIGH, due_date: '2025-09-10T23:59:59Z', created_at: '2025-07-10T10:00:00Z', updated_at: '2025-07-15T10:00:00Z', attachments: [{ filename: 'debug-log.txt', url: 'data:text/plain;charset=utf-8,This%20is%20a%20mock%20debug%20log%20file.'},{ filename: 'screenshot-error.png', url: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=' }] },
];
