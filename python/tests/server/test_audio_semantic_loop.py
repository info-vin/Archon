...
async def test_audio_semantic_loop_live(client):
    ...
    try:
        ...
        try:
            ...
            err_msg = str(e)
            if any(msg in err_msg for msg in ["leaked", "PERMISSION_DENIED", "API key was reported as leaked", "API_KEY_INVALID", "500 INTERNAL", "503 UNAVAILABLE", "429", "quota", "ResourceExhausted", "Too Many Requests"]):
