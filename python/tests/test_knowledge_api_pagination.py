...
def test_knowledge_summary_endpoint(client, mock_supabase_client):
    ...
    response = client.get("/api/knowledge-items", params={"page": 1, "per_page": 10})
...
def test_summary_search_filter(client, mock_supabase_client):
    ...
    response = client.get("/api/knowledge-items", params={"search": "test"})
...
def test_summary_knowledge_type_filter(client, mock_supabase_client):
    ...
    response = client.get("/api/knowledge-items", params={"knowledge_type": "technical"})
