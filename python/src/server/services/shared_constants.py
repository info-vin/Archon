...
class PromptNameEnum(StrEnum):
    ...
    MAP_REDUCE_POBOT_PROMPT = "MAP_REDUCE_POBOT_PROMPT"
    MAP_REDUCE_BUSINESS_PROMPT = "MAP_REDUCE_BUSINESS_PROMPT"
    MAP_REDUCE_ENGINEERING_REDUCER_PROMPT = "MAP_REDUCE_ENGINEERING_REDUCER_PROMPT"
