...
class EmbeddingQuotaExhaustedError(EmbeddingError):
    ...
    def __init__(self, message: str, tokens_used: int | None = None, **kwargs: Any) -> None:
...
class EmbeddingRateLimitError(EmbeddingError):
    ...
    def __init__(self, message: str, retry_count: int = 0, **kwargs: Any) -> None:
        super().__init__(message, **kwargs)
...
class EmbeddingValidationError(EmbeddingError):
    ...
    def __init__(self, message: str, embedding_sample: list[float] | None = None, **kwargs: Any) -> None:
        super().__init__(message, **kwargs)
        if embedding_sample:
