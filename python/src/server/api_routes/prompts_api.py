...
from src.server.schemas.prompts import PromptResponse, PromptUpdateRequest, PromptUpdateResponse
...
async def list_all_prompts(current_user: UserProfileDTO = Depends(get_current_user)) -> list[PromptResponse]:
